...
import com.loguito.brainmove.viewmodels.UserDetailsTrendsViewModel
import kotlinx.android.synthetic.main.fragment_trends.*

class UserDetailsTrendsFragment : Fragment() {
    private lateinit var viewModel: UserDetailsTrendsViewModel
    private lateinit var measures: List<Measure>
    private val adapter = TrendOptionsAdapter()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        viewModel = ViewModelProvider(this).get(UserDetailsTrendsViewModel::class.java)
    }
